    ...
    // If the query has no records => No author with the email exists (New Author)
      ...
      if($check_user_row > 0) {
        ...
        if($author_result && $user_result) {
          ...
          alert("Author Signup Successful");
          redirect('./index.php');
        }
      ...
      // If the query has no records => No user with the email exists (New User)
        ...
        if($user_result && $author_result) {
          ...
          // Redirected to login page with a message
          alert("Author and User Signup Successful");
          redirect('./index.php');
        }
        // If the Query failed
        else {
...
<style>
    ...
    min-height: 80vh; /* Adjusts based on your body content height */
}
...
.form-container {
    ...
    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); /* Optional: adds shadow for design */
    ...
    <!-- Right div for Signup -->
      <div class="form-container">
        <div class="form-title">
          <h4><b>Author Signup</b></h4>
        </div>
        <div class="registration-form">
          <form method="POST" class="registration-form" id="signup-form">
